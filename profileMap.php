...
<head>
  ...
  function loadMap(){
    ...
    var latU2;
    var lngU2;
    $.getJSON('https://api.opencagedata.com/geocode/v1/json?q='+"Montpellier"+'&key=816e747854f64c8389a43b269e5b74d9&language=en&pretty=1',
    function(data){
  ...
  <div class="wrapper">
    <div class="profile-card js-profile-card">
      ...
      <div class="profile-card__cnt js-profile-cnt">
        ...
        <br>
        <div class="profile-card-loc">
          <input type="text" value="2 rue du petit paris montpellier" id="add" hidden>
