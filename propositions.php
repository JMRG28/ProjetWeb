...
?>
    ...
    <div class="container">
        <div class="header-page ef-parallax-bg" style="background-image:url(img/home/prop.jpg)">
                ...
                <div class="row">
                    <div class="inner-content">
                        <div class="header-content">
                            <h1>Propositions</h1>
                            <hr>
                            <p>Tout ce que vous souhaitez au coin de votre rue</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="js-masonry">
                <div class="row" id="work-grid">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix web">
                        <div class="img home-portfolio-image">
                            <img src="img/blender.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 mix graphic">
                        <div class="img home-portfolio-image">
                            <img src="img/perc.jpg" alt="Portfolio Item">
                            <div class="overlay-thumb">
                                <a href="javascript:void(0)" class="like-product">
                                    <i class="ion-ios-heart-outline"></i>
                                    <span class="like-product">Liked</span>
